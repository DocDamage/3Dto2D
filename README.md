...
*   Edit assets in-browser with pencil, eraser, fill, picker, line, rectangle, selection/move, PNG import/export, version saves, mock AI inpainting, and variant-first outfit/part application workflows.
