(function () {
  ...
  window.spriteForgeScriptList = function spriteForgeScriptList() {
    return [
      ...
      'js/play_workbench.js?v=console-product-polish-v12',
      'js/compare_player.js',
      'js/lighting_preview.js',
      'js/cloud_hub.js',
      'js/frame_editor.js',
      'js/production_studio.js',
      'js/aaa_studio.js',
      'js/prompt_builder.js?v=prompt-autofix',
      'js/seed_gallery.js',
      'js/frame_review.js',
      'js/palette_harmonizer.js',
      'js/keyboard_shortcuts.js?v=console-product-polish-v12',
      'js/theme_toggle.js',
      'js/mobile_nav.js',
      ...
      'js/app_views.js',
      'js/app_notifications.js?v=console-product-polish-v12',
      ...
      'js/wizard_state.js',
      'js/wizard_submit.js?v=wizard-product-ready-v12',
      'js/wizard_ui.js?v=wizard-product-ready-v12',
      'js/wizard.js?v=wizard-product-ready-v12',
      'js/app_dashboard.js?v=dashboard-fit-no-window-resize',
      'js/command_palette.js',
      'js/consumer_experience.js?v=console-product-polish-v12',
      'js/playful_console.js?v=console-product-polish-v12',
      'js/ux_enhancements.js?v=console-product-polish-v12',
