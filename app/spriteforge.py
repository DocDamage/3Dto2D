...
def add_common_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--resolution-hierarchy", default=None, help="Alias for --resolutions. Example: 128,64,32")
    ...
    p.add_argument("--matting-engine", choices=["chroma", "rembg", "birefnet", "depth-anything", "pixel-art"], default="chroma", help="Matting engine to use for background removal")
    ...
    p.add_argument("--temporal-smooth", action="store_true", help="Reduce frame-to-frame RGB flicker and alpha-edge jitter")
    p.add_argument("--temporal-smooth-radius", type=int, default=1, help="Sliding window radius for temporal smoothing")
    p.add_argument("--temporal-smooth-color-strength", type=float, default=0.35, help="RGB temporal smoothing strength from 0 to 0.95")
    p.add_argument("--temporal-smooth-alpha-strength", type=float, default=0.55, help="Alpha temporal smoothing strength from 0 to 0.95")
    p.add_argument("--temporal-smooth-no-histogram", action="store_true", help="Disable histogram matching before temporal smoothing")
    ...
    p.add_argument("--pixel-snap-scale", type=int, default=0, help="Scale/pixel size for pixel-art grid snapping. 0 disables.")
    ...
    p.add_argument("--interpolation-engine", choices=["blend", "flow", "bitmapflow", "rife"], default="blend", help="Native interpolation engine")
    p.add_argument("--pack-mode", choices=["grid", "maxrects"], default="grid", help="Packing mode: grid alignment or MaxRects tight packing")
    p.add_argument("--segment-parts", default=None, help="Part segmentation click specifications, e.g. weapon:150,220,1;hair:200,100,1")
